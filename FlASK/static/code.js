$(function(){
  $.get('/graph', function(result) {
    ...
    var cy =window.cy = cytoscape({
      ...
      .selector('node[label = "Acupoint"]').css({'background-color': '#6FB1FC','content': 'data(name)'}) //节点样式
      .selector('node[label = "Disease"]').css({'background-color': '#F5A45D','content': 'data(name)'})
